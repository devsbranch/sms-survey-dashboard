...
then
    ...
    rsync -L  backups/latest.dmp staging.ppcr-tralard.digiprophets.com:/home/ppcr-tralard/deployment/backups/
    rsync -r -v media/ staging.ppcr-tralard.digiprophets.com:/home/ppcr-tralard/deployment/media
	...
	ssh staging.ppcr-tralard.digiprophets.com "cd /home/ppcr-tralard/deployment && git fetch --tags && git checkout $VERSION && make collectstatic && make reload"
else
