...
$(document).ready(function () {
  ...
  $(".widget-bars-secondary").peity("bar", {
    fill: ["#21546d"],
    height: 85,
    width: "100%",
  });
  ...
  if (
    $(
      ".peityjs-pie, .peityjs-pieAlt, .peityjs-donut, .peityjs-donutAlt, .peityjs-line, .peityjs-bar, .peityjs-line-updating"
    ).length
  ) {
    //Peity pies
        ...
        datasets: [
          {
            ...
            data: [12470, 15267, 11734, 19784, 12433],
          },
        ],
      },
      options: {
  ...
  if ($("#billboard-stackedbarChart").length) {
    var chart = bb.generate({
      data: {
        ...
        type: "bar",
        groups: [["Deals won", "Deals lost", "Deals canceled"]],
      },
      grid: {
        y: {
          lines: [
  ...
  if ($("#billboard-gaugeChart").length) {
    var chart = bb.generate({
      ...
      gauge: {},
      color: {
        pattern: ["#FF0000", "#F97600", "#F6C600", "#21546d"],
        threshold: {
          values: [30, 60, 90, 100],
        },
      },
