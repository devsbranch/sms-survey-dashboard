...
$(document).ready(function(){
    ...
    $(window).on('scroll', function () {
        ...
        if (height > 60) {
            $('.dashboard-nav').addClass('is-scrolled');
        } else {
            $('.dashboard-nav').removeClass('is-scrolled');
        }
    });
    ...
    (function ($) {
        ...
        $.fn.initPopDropdowns = function () {
            $('.drop-pop .icon-button').on('click', function () {
                $('.drop-wrapper').removeClass('is-active');
                $(this).siblings('.drop-wrapper').addClass('is-active')
            })
            $(document).click(function (e) {
                var target = e.target;
                if (!$(target).is('.drop-wrapper') && !$(target).parents().is('.drop-pop')) {
                    $('.drop-wrapper').removeClass('is-active');
                }
            });
        };
