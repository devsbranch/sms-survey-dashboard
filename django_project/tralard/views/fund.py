...
def fund_delete(request, program_slug, project_slug, fund_slug):
    ...
    return redirect(reverse_lazy('tralard:fund-list', kwargs={
...
@login_required(login_url='/login/')
def delete_disbursement(request, program_slug, project_slug, fund_slug, disbursement_slug):
...
@login_required(login_url='/login/')
def update_disbursement(request, program_slug, project_slug, fund_slug, disbursement_slug):
